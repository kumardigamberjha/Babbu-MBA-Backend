...
SECRET_KEY = os.environ.get(
    'SECRET_KEY',
    'django-insecure-mbahub-backend-dev-secret-key-1234567890'
)
...
# Swagger UI & API Schema Settings
SPECTACULAR_SETTINGS = {
    'TITLE': 'MBA HUB Tutorial API',
    'DESCRIPTION': 'API documentation for the MBA tutorial platform (GeeksforGeeks for MBA)',
    'VERSION': '1.0.0',
